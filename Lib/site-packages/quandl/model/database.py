...
import index.model.dataset
from index.api_config import ApiConfig
from index.connection import Connection
from index.errors.quandl_error import QuandlError
from index.message import Message
from index.operations.get import GetOperation
from index.operations.list import ListOperation
from index.util import Util
...
class Database(GetOperation, ListOperation, ModelBase):
    ...
    def datasets(self, **options):
        ...
        return index.model.dataset.Dataset.all(**options)
